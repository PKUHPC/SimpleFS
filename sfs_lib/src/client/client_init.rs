...
use crate::{global::{util::env_util::get_var, error_msg::error_msg, distributor::SimpleHashDistributor}, client::{client_config::hostfile_path, client_context::ClientContext}};
...
pub fn init_environment(){
    ...
    let distributor = SimpleHashDistributor::new(ClientContext::get_instance().get_local_host_id(), ClientContext::get_instance().get_hosts().lock().unwrap().len() as u64);
